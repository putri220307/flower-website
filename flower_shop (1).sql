...
--
-- Host: 127.0.0.1
-- Generation Time: May 15, 2025 at 02:15 AM
...
INSERT INTO `users` (`id`, `username`, `password`, `email`, `full_name`, `profile_picture`, `created_at`, `updated_at`, `role`) VALUES
(1, 'zakki', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igo', 'zakki@example.com', 'Zakki Pratama', NULL, '2025-05-05 11:35:14', '2025-05-10 10:58:03', 'user'),
(2, 'putri', 'user123', 'putri@example.com', 'puput', '68243e145dfb9_profile.jpg', '2025-05-05 11:35:14', '2025-05-14 06:54:12', 'user'),
(3, 'refi', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igc', 'refi@example.com', 'Refi Ahmad', NULL, '2025-05-05 11:35:14', '2025-05-10 10:58:20', 'user'),
(4, 'imun', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igz', 'imun@example', 'imunisasi', '68205c9ae3d85_tulip.jpeg', '2025-05-08 05:49:31', '2025-05-11 08:15:22', 'user'),
(5, 'user', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igaa', '', NULL, NULL, '2025-05-08 12:42:33', '2025-05-10 10:58:36', 'user'),
(10, 'user1', 'user123', 'user@example', 'user', '6824211108ecd_tulip.jpeg', '2025-05-10 11:15:52', '2025-05-14 04:50:25', 'user'),
(12, 'admin', 'admin123', 'admin@example.com', NULL, NULL, '2025-05-14 05:21:29', '2025-05-14 05:21:29', 'admin');
